...
client.listing_statuses_for_integrations # List and search the listing status of pending properties to your integration. For integration partners use only
```
